...
void OverlaySunGlasses(Mat& frame, String path)
{
	//训练好的文件名称
	string faceCascadeName = path + "/cascadeFiles/haarcascade_frontalface_alt.xml";
    string eyeCascadeName = path + "/cascadeFiles/haarcascade_eye.xml";
	...
	String eyeMaskFileName = path + "sunglasses.png";
    Mat eyeMask = imread(eyeMaskFileName);
